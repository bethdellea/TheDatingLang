...
SADWINcookies = { "__cfduid" : "d2f8afb7f76247f3edc833502030460451441576259",
            "authlink" : "6b28378b",
...
rget = requests.get("http://okcupid.com/match", headers=definitelyChrome, cookies=SADWINcookies)
